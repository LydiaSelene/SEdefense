...
public class SpawnWaves_Level1 : MonoBehaviour{
	 ...
	 void wave0(){
		switch(patternint){
			...
			case 1:
				delay0 = delay0 - (Time.deltaTime % 60);
				if(delay0 <= 0){
					GameObject m = Instantiate(Enemy_FrozenWolf, new Vector3(23.7f,0.0f), Quaternion.identity) as GameObject;
					m.SendMessage ("setWaypoints", waypoints, SendMessageOptions.RequireReceiver );
					delay0 = 2.0f;
					patternint = 0;
					amount0--;
	 ...
	 void wave2(){
		switch(patternint){
			...
			case 4:
				delay2 = delay2 - (Time.deltaTime % 60);
				if(delay2 <= 0){
					GameObject m = Instantiate(Enemy_BugSoldier, new Vector3(23.7f,0.0f), Quaternion.identity) as GameObject;
					m.SendMessage ("setWaypoints", waypoints, SendMessageOptions.RequireReceiver );
					delay2 = 1.0f;
					patternint = 0;
					amount2--;
	 ...
	 void wave4(){
		switch(patternint){
			case 0:
				...
				if(delay4 <= 0){
					GameObject m = Instantiate(Enemy_Goblin1, new Vector3(23.7f,0.0f), Quaternion.identity) as GameObject;
					m.SendMessage ("setWaypoints", waypoints, SendMessageOptions.RequireReceiver );
					delay4 = 3.0f;
					patternint++;
					amount4--;
			...
			case 1:
				delay4 = delay4 - (Time.deltaTime % 60);
				if(delay4 <= 0){
					GameObject m = Instantiate(Enemy_Goblin2, new Vector3(23.7f,0.0f), Quaternion.identity) as GameObject;
					m.SendMessage ("setWaypoints", waypoints, SendMessageOptions.RequireReceiver );
					delay4 = 3.0f;
					patternint = 0;
					amount4--;
	 ...
	 void wave6(){
		switch(patternint){
			case 0:
				...
				if(delay6 <= 0){
					GameObject m = Instantiate(Enemy_Mantis, new Vector3(23.7f,0.0f), Quaternion.identity) as GameObject;
					m.SendMessage ("setWaypoints", waypoints, SendMessageOptions.RequireReceiver );
					delay6 = 3.0f;
					patternint = 0;
					amount6--;
	 ...
	 void wave7(){
		switch(patternint){
			case 0:
				...
				if(delay7 <= 0){
					GameObject m = Instantiate(Enemy_Cookie1, new Vector3(23.7f,0.0f), Quaternion.identity) as GameObject;
					m.SendMessage ("setWaypoints", waypoints, SendMessageOptions.RequireReceiver );
					delay7 = 4.0f;
					patternint = 0;
					amount7--;
	 ...
	 void wave8(){
		switch(patternint){
			...
			case 4:
				delay8 = delay8 - (Time.deltaTime % 60);
				if(delay8 <= 0){
					GameObject m = Instantiate(Enemy_Santa, new Vector3(23.7f,0.0f), Quaternion.identity) as GameObject;
					m.SendMessage ("setWaypoints", waypoints, SendMessageOptions.RequireReceiver );
					delay8 = 4.0f;
					patternint = 0;
					amount8--;
